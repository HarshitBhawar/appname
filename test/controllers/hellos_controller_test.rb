...
class HellosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hello" do
    assert_difference("Hello.count") do
      post hellos_url, params: { hello: { content: @hello.content, name: @hello.name, title: @hello.title } }
    end
  ...
  test "should update hello" do
    patch hello_url(@hello), params: { hello: { content: @hello.content, name: @hello.name, title: @hello.title } }
